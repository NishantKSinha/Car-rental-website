    ...
    pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <div className='group relative'>
            <label htmlFor="image">
                ...
                }  alt="" className='h-9 md:h-16 w-9 md:w-16 rounded-full mx-auto'/>
        ...
        {image &&(
            ...
            text-primary cursor-pointer'onClick={updateImage}>Save <img src={assets.check_icon} width={13} alt="" 
            /></button>
        )}
         ...
         <div className='w-full'>
            {ownerMenuLinks.map((link,index)=>(
                 ...
                 items-center gap-2 w-full py-3 pl-4 first:mt-6 ${link.path === location.pathname ?
                    ...
                    <img src={link.path === location.pathname ? 
                        link.coloredIcon : link.icon} alt="car icon" />
