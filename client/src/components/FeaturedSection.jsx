...
const FeaturedSection = () => {
  ...
  return (
    ...
    lg:px-24 xl:px-32'>
        <motion.div
         initial={{ opacity:0,y:20}}
          ...
          transition={{duration:1,delay:0.5}}>
            <Title title='Feature Vechiles' subTitle='Explore your selection
            of premium vechiles available for your next adventure.'/>
        </motion.div>
        ...
        className='flex items-center justify-center gap-2 px-6 py-6 border
