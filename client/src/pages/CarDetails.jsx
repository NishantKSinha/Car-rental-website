...
const CarDetails = () => {
  ...
  return car ?(
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      transition={{duration:0.5}}  src={car.image} alt="" className='w-full h-auto md:max-h-100 object-cover rounded-xl mb-6 shadow-md'/>
            <motion.div
             initial={{ opacity:0}}
          animate={{opacity:1}}
      transition={{duration:0.5,delay:0.2}} 
       className='space-y-6'>
          ...
          text-gray-500'>
            ...
            transition-all py-3 font-medium text-white 
