    ...
    text-sm max-w-7xl'>
         ...
         <div>
           {bookings.map((booking,index)=>(
            ...
            animate={{opacity:1, y:0}}
            transition={{duration:0.4,delay:index*0.1}}key={booking._id}
            ...
            p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
              ...
              <div className='md:col-span-1'>
                <div className='rounded-md overflow-hidden mb-3'>
                    <img src={booking.car.image} alt="" className='w-full
                ...
                <div className='flex items-center gap-2'>
                  <p className='px-3 py-1.5 bg-light rounded'>Booking #{index+1}</p>
                   <p className={`px-3 py-1 text-xs rounded-full ${booking.status==='confirmed'?
                    'bg-green-400/15 text-gray-600' : 'bg-red-400/15 text-red-600'}`}>{booking.status}</p>
                </div>
